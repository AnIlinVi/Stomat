...
// ---------- УСЛУГИ С КАРТИНКАМИ ----------
const servicesData = [
    { name: "Консультация и осмотр", desc: "Первичный приём с составлением плана лечения, рентген-диагностика включена.", price: "Бесплатно", imageUrl: "img/bmw-x5.jpg" },
    ...
    { name: "Отбеливание ZOOM", desc: "Безопасное отбеливание на 4-6 тонов за сеанс.", price: "12 000 ₽", img: "https://anilinvi.github.io/Stomat/img/Услуги/Отбеливание ZOOM.png" },
